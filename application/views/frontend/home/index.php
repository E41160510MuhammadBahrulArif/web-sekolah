<!-- ##### Hero Area Start ##### -->
<section class="hero-area bg-img bg-overlay-2by5" style="background-image: url(<?= base_url('assets/img/banner/') . set_banner()->banner_image ?>);">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <!-- Hero Content -->
                <div class="hero-content text-center">
                    <h2><?= set_banner()->banner_title ?></h2>
                    <span class="btn clever-btn"><?= set_banner()->banner_subtitle ?></span>
                        ...
                        <?php foreach ($all_jurusan as $jurusan) : ?>
                            ...
                            <div class="single-tutors-slides">
                                ...
                                <div class="tutor-thumbnail">
                                    <img src="<?= base_url('assets/img/jurusan/') . $jurusan['img_jurusan'] ?>" alt="">
                                </div>
                                <!-- Tutor Information -->
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="250ms">
                            ...
                            <div class="events-thumb">
                                <img src="<?= base_url() ?>assets/img/background/pengumuman2.png" alt="">
                ...
                <?php foreach ($new_agenda as $agenda) : ?>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="250ms">
                            <!-- Events Thumb -->
                            <div class="events-thumb">
                                <img src="<?= base_url() ?>assets/img/background/agenda2.png" alt="">
